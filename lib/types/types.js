 ...
 * @property {number} SEEDV2_DEPLOY_INSTANCE - for deploying Seed instance
 * @property {number} SEEDV2_INITIALIZE - for init Seed
 * @property {number} SEEDFACTORYV2_DEPLOY_INSTANCE - for deploying SeedFactory
 * @property {number} SEEDFACTORYV2_DEPLOY_SEED - for deploying Seed from SeedFactory
 * @property {number} SEEDV2_CHANGE_CLASSES_AND_ALLOWLISTS - for changing a class
 */
 ...
 * @property {Address=} projectAddresses -
